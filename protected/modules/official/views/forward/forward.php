<div class="content">
   ...
   <div class="content-center">
   		<ul class="tag" style="margin-bottom:20px;">
		 	 	<li ><a href="<?php echo Yii::app()->createUrl('official/forward/index');?>">未转发</a></li>
		 	 	<li class="active"><a href="<?php echo Yii::app()->createUrl('official/forward/list');?>" >已转发</a></li>
		 </ul>
       <form id="search-form" action="" method="get">
		 <div class="search">
		 	 <input type="text" name="param[title]" class="input-xxlarge" value="<?php if(isset($param['title']) && $param['title'] !== ''){ echo trim($param['title']); } ?>" placeholder="文章标题" >
						      	...
						      	<div class="author clearfix"  id="container">
										...
										<ul class="author-msg">
										    <li class="name">
                                                ...
                                                <?php if($v->close === '2'): ?>
                                                    <a class="btn btn-mini btn-danger published">原帖已封</a>
                                                <?php endif; ?>
                                            </li>
										    </li>
										    <li class="edit-img">公众号ID：<span><?php echo $v->offic->openid; ?></span>公众号名称：<span><?php echo $v->offic->openname; ?></span>转发时间：<span><?php echo Message::formatTime(Message::defaultTime($v->sen['publishtime'])); ?></span></li>
										</ul>
								</div>
							</div>
					  </td>
					  <td class="operation">
                          <a href="javascript:;" class="del-btn" data-href="<?php echo Yii::app()->createUrl('/official/forward/delete', array('sid'=>$v->sen['sid'])); ?>"><i class="icon3"></i>删除</a>
					  </td>
					</tr>
                    <?php endforeach; ?>
                    <?php else: ?>
...
<div id="publish" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	  ...
	  <div class="modal-body">
		...
		<div class="modal-footer">
			    <a href="javascript:;" class="btn btn-pale-green btn-mini btn-radius  comfirm" data-dismiss="modal" aria-hidden="true">确认</a>
