...
<head>
    ...
    <style>
        ...
        * { -webkit-tap-highlight-color: transparent; }
        html,body{ width: 100%; height: auto; padding: 0;  margin: 0 auto; background-color: #f5f0dc;}
        ...
        <div id="layout" class="layout" style=" max-width: 430px; background: #fef0bf; "> 
            <div class="layout-main">
                <div class="img-box" style="min-height: 100px;">
                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/image/banban/mobile/posts/p_sw_01.jpg" />
                </div> 
