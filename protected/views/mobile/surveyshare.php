...
<style>
    ...
    * { -webkit-tap-highlight-color: transparent; }
    ...
    .f-left{ float: left; }
    .f-right{ float: right; }
    .layout{ position: relative; max-width:450px; height: 100%; margin:0 auto;  font-family: "黑体";background:url('/image/banban/mobile/survey/bg.jpg') repeat-y; background-size: contain; } 
...
<body> 
    ...
    <div style=" display: none;">
        ...
        <ul class="oplist">
            <li class="bg00_0"></li><li class="bg10_0"></li><li class="bg20_0"></li><li class="bg20_0"></li><li class="bg00_1"></li><li class="bg10_1"></li>
            <li class="bg20_1"></li><li class="bg20_1"></li><li class="bg00"></li><li class="bg10"></li><li class="bg20"></li><li class="bg20"></li>
        </ul>
    </div>
	<div id="layout" class="layout">
            ...
            <!-- /提示 -->
            <!--提交表单-->
            <form id="postForm" method="post" action="<?php echo Yii::app()->createUrl("/mobile/surveyshare/$id");?>" >
                ...
                for(var i=0; i< qIemt.length; i++){  
                    qIemt[i].onclick=function(e){ 
                        ...
                        if(parseInt(num)>0){//
                            ...
                            MotionFrames.startMove(pid,{},650,function(){
            ...
            psotResult:function(obj){//提交结果 
                ...
                qIemt.onclick =function(){ 
                    ...
                    var tObj = pid,type=this.getAttribute('types'); 
                        var num =survey.verdict(tObj,type);//当前题目选择了几个选项   
                        if(parseInt(num)>0){ 
                            if(survey.itemClass[type]=="alone"||survey.itemClass[type]=="double") {//单选和多选显示对错 
                                survey.verdictResult(pid,type);
                            } 
                            survey.popupTier('popupMask').style.display = 'block'; 
                            MotionFrames.startMove(pid,{},250,function(){ 
