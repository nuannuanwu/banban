...
<head>
    ...
    <style>
        ...
        * { -webkit-tap-highlight-color: transparent; }
        ...
        .c-box p{ color: #FFFFFF; margin: 3px 0; font-size: 17px; }
...
<body <?php if($ac=='webac'): ?>style=" background-color:#fa784d; "<?php endif; ?>>  
    <div class="page page-1" style="">
        <div id="layout" class="layout" style=" background-color: #fa754b; <?php if($bt=='web'): ?>width: 430px;<?php endif; ?>"> 
            <div class="layout-main" >
                <div class="c-box" style=" display: none; padding: 5% 0;">
                    <p> 您已经领取过班费卡了哦~</p>
                    <p>班费卡已放入账户 <?php echo $mobile; ?></p>
                </div>
                <div class="img-box">
                    <?php if($state==$this::RES_GET_INVITED_CLASS_FEE_CARD_PHONE_EXIST): ?>
                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/image/banban/mobile/invit/i_tp_01.jpg" />
                    <?php else: ?>
                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/image/banban/mobile/invit/i_tp_01_1.jpg" />
                    <?php endif ?>
                </div>
                 <div class="img-box">
                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/image/banban/mobile/invit/i_tp_02.jpg" /> 
                </div>
                <?php if($bt=='app'): ?>
                ...
                <?php endif; ?> 
                <?php if($bt=='web'): ?>
                    <div style=" width: 76.67%; margin: 0 auto; padding: 20px 0;">
                        <form id="formBoxRegister" action="" method="post">
                            <div style=" margin: 10px 0; color: #ffffff; font-size: 18px;">
                                免费发送短信到手机下载
                            </div>
                    ...
                    <div class="img-box" style=" text-align: center;">
                        <img style=" display: inline-block;" src="<?php echo Yii::app()->request->baseUrl; ?>/image/banban/mobile/clas/t_sb.png" /> 
                    </div>
                     <div class="img-box" style=" text-align: center; margin: 40px 0;">
                        ...
                        <p style=" font-size: 18px; margin-top: 15px; color:#fff;">二维码扫描下载</p>
                    </div>
