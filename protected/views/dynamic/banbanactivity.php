...
<head>
    ...
    <title>活动推广 - 班班平台活动，班班活动推广。班班客服：400 101 3838</title>
    <meta name="keywords" content="班班,班班网,班班活动,班班活动推广,班务管理,作业通知,蜻蜓校信,蜻蜓班班,校信,校信通,校讯通,家校互动,家校沟通,免费校讯通,班费,青豆">
    <meta name="description" content="班班活动推广，有关班班活动的展示及推广。">
    ...
    <div class="container about">
        <div class="sidebar">
            <ul>
                ...
                <li><a href="<?php echo Yii::app()->createUrl('dynamic/banbanactivity')?>" class="active">活动推广</a></li>
