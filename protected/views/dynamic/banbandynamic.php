...
<head>
    ...
    <title>产品动态 - 班班动态及班班产品动态。班班客服：400 101 3838</title>
    <meta name="keywords" content="班班,班班网,班班产品动态,班班动态,班务管理,作业通知,蜻蜓校信,蜻蜓班班,校信,校信通,校讯通,家校互动,家校沟通,免费校讯通,班费,青豆">
    <meta name="description" content="班班产品动态，关于班班产品信息，班班动态的展示。">
...
<div style="border-top:8px solid #F59201;">
    <div class="container about">
        <div class="sidebar">
            <ul>
                <li><a href="<?php echo Yii::app()->createUrl('dynamic/banbandynamic')?>" class="active">产品动态</a></li>
                <li><a href="<?php echo Yii::app()->createUrl('dynamic/banbanactivity')?>">活动推广</a></li>
                <li><a href="<?php echo Yii::app()->createUrl('dynamic/banbannews')?>">行业资讯</a></li>
            </ul>
        </div>
