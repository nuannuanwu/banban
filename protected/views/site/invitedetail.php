...
<body> 
    <div id="contentBox" class="layout_div">
	    ...
	    <div class="container y">
	    	 <div class="content ">
	    	 	<img src="<?php echo Yii::app()->request->baseUrl; ?>/image/banban/invite/header.jpg" /> 
	    	 </div>
	    </div>
        <div class="container y">
	    	 <div class="content ">
	    	 	<img src="<?php echo Yii::app()->request->baseUrl; ?>/image/banban/invite/banner.jpg" /> 
	    	 </div>
	    </div>
	    <div class="container y">
	    	 <div class="content ">
	    	 	 <img src="<?php echo Yii::app()->request->baseUrl; ?>/image/banban/invite/set_tep1.jpg"/> 
	    	 </div>
	    </div>
	    <div class="container y">
	    	 <div class="content ">
	    	 	<img src="<?php echo Yii::app()->request->baseUrl; ?>/image/banban/invite/set_tep2.jpg"/> 
	    	 </div>
	    </div>
        <div class="container y">
	    	 <div class="content ">
	    	 	<img src="<?php echo Yii::app()->request->baseUrl; ?>/image/banban/invite/title.jpg"/> 
	    	 </div>
	    </div>
        <div class="container y">
	    	 <div class="content ">
	    	 	<img src="<?php echo Yii::app()->request->baseUrl; ?>/image/banban/invite/rule.jpg"/> 
	    	 </div>
	    </div>
        <div class="container y">
	    	 <div class="content ">
	    	 	<img src="<?php echo Yii::app()->request->baseUrl; ?>/image/banban/invite/footer.jpg" />
	    	 </div>
	    </div>
