...
$(function() {
    ...
    function addInput(str){
        var itme ='<tr><td style="width:10px;"><div class="inputBox"><input rel="name" name="Teacher[name][]" maxlength="10" class="sm" type="text" placeholder="输入姓名" >'
                +'<br/><span class="ValidTip Validform_checktip" >&nbsp;</span></div></td>'
                +'<td style="width:325px;"><div class="inputBox"><input rel="mobile" name="Teacher[mobile][]" maxlength="11" class="mediumL" type="text" placeholder="输入电话">'
