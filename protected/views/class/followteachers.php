    ...
    <div id="contentBox" class="cententBox"> 
        ...
        <div class="box">
            <nav class="navMod">
                ...
                <a href="<?php echo Yii::app()->createUrl('class/classinfo',array('cid'=>$class->cid,'ac'=>'followclassteachers'));?>" class="btn btn-default">班级属性</a>
            ...
            <div class="titleBox">
                <ul class="titleTable"> 
                    <li><a href="<?php echo Yii::app()->createUrl('/class/followclassstudents/'.$class->cid);?>">学生</a></li>
                    <li><a href="<?php echo Yii::app()->createUrl('/class/followclassteachers/'.$class->cid);?>" class="focus">老师</a></li>
                </ul> 
            </div> 
...
<script type="text/javascript">
    ...
    var shareUrl = '<?php echo Yii::app()->createAbsoluteUrl('mobile/classintro', array('classid'=>$class->cid,'uid'=>Yii::app()->user->id,'role'=>'4'));?>';
