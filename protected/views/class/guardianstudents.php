    ...
    <div id="contentBox" class="cententBox"> 
        ...
        <div class="box">
            <nav class="navMod">
                ...
                <a href="<?php echo Yii::app()->createUrl('class/classinfo',array('cid'=>$class->cid,'ac'=>'guardianstudents'));?>" class="btn btn-default">班级属性</a>
            ...
            <div class="titleBox">
                <ul class="titleTable">
                    <li><a href="<?php echo Yii::app()->createUrl('/class/guardianstudents/'.$class->cid);?>" class="focus">学生</a></li>
                    <li><a href="<?php echo Yii::app()->createUrl('/class/guardianteachers/'.$class->cid);?>" >老师</a></li> 
                </ul>
            </div>
            <div class="classMemberBox" >
                ...
                <?php if($mychilds||$otherchilds): ?>
                    <?php if($mychilds):?>
                <div class="memberListBox"> 我的孩子：
                    <?php foreach($mychilds as $vchild):?>
                    <a class="mychild hidden" href="" title="点击添加家属"></a><span class="careman"><?php echo $myChildName=$vchild->name;?></span>
                    <a class="btn btn-default" style="text-decoration: none;" href="<?php echo Yii::app()->createUrl('class/guardians/'.$vchild->sid.'?cid='.$class->cid);?>">查看关注人</a>
                    <?php endforeach;?>
                </div>
                    <?php endif;?>
                    <?php if($otherchilds):?>
...
<div id="disbandBox" class="popupBox">
    ...
    <div class="remindInfo">
        <div id="remindText" class="centent">您和您的孩子<?php echo '“'.$myChildName.'”';?>及其所有的关注人，都将退出该班级，不再接收该班级的任何通知消息。</div>
    </div>
    <div class="popupBtn">
