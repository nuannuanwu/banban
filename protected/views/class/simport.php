        ...
        <div class="box">
            <div class="formBox">
                <div class="classTableBox invtesBox"> 
                    <form id="formBoxRegister" action="<?php echo Yii::app()->createUrl('/class/simport/'.$class->cid);?>?ty=import" method="post">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href="<?php echo Yii::app()->createUrl('class/supload?cid='.$class->cid);?>" class="btn btn-default">返回</a>    &nbsp;&nbsp;&nbsp;
                                        <?php if($total>0):?>
                                        <a href="javascript:;" url="<?php echo Yii::app()->createUrl('class/simport/'.$class->cid);?>?ty=import" tip="0" id="postBnt" class="btn btn-orange">下一步</a>
                                        <?php else:?>
...
<div id="inviteBox" class="popupBox" style=" width: 600px;">
    <div class="header">发送邀请 <a href="<?php echo Yii::app()->createUrl('class/students/'.$class->cid);?>" class="close"  > </a></div>
    ...
    <div class="popupBtn">
        <a id="delayPostBtn" href="<?php echo Yii::app()->createUrl('class/students/'.$class->cid);?>" class="btn btn-orange">稍后发送</a>
