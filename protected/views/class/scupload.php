                    ...
                    <form id="formBoxRegister" action="<?php echo Yii::app()->createUrl('/class/scheck/'.$class->cid);?>" method="post">
                        <table class="tableForm" id="tableFormAdd">
                            <tbody>
                                <tr>
                                    <td>
                                        <span style="font-size: 16px; color: #666666;">录入班级成员</span>
                                    </td> 
                                </tr>
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    <td>
                                        ...
                                        &nbsp;&nbsp;
<!--                                        <a class="btn btn-default" href="<?php echo Yii::app()->createUrl('/class/students/'.$class->cid);?>" >返回</a> -->
                                    </td>
                                </tr>
                            </tbody>
                        </table> 
    ...
    $("#fileExcle").uploadify({ 
        ...
        'onUploadSuccess':function(file, data, response){ 
            ...
            if(data=='0'){
                ...
                window.location="<?php echo Yii::app()->createUrl('/class/scimport/'.$class->cid);?>";
            }
        }, 
