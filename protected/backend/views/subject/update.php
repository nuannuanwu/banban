                ...
                <tr>
                    ...
                    <td>
                        <div style="display: inline;">
                            <input value="<?php echo $model->name; ?>" name="Subject[name]" class="input-large" size="10" maxlength="25" datatype="*1-20" nullmsg="科目名称不能为空！" errormsg="科目名称长度不能大于20个字！"type="text">
                        </div>
                        ...
                        <div style="display: inline;">
                            <select  name="Subject[schoolid]" style="width:250px;" datatype="*" nullmsg="请选择学校！" id="selectsid" url="<?php echo Yii::app()->createUrl('range/getschoolgrade' );?>">
                                ...
                                <?php foreach($schools as $k=>$v):?>
                                    <option value="<?php echo $k;?>" <?php if($k==$model->schoolid) echo 'selected="selected"'; ?>><?php echo $v;?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
            ...
            <table class="tableForm">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a rel="deleLink" class="btn btn-primary" href="javascript:void(0);" data-href="<?php echo Yii::app()->createUrl('subject/delete/'.$model->sid."?list=1");?>">删  除</a>&nbsp;&nbsp;
