    ...
    <?php $form=$this->beginWidget('CActiveForm', array(
        ...
        <table class="tableForm">
            ...
            <tbody>
                    ...
                    <td>
                        ...
                        <div class="Validform_checktip " style=" display: inline;">
                            ...
                            <span id="Information_kindtop" class="radioBox" > 
                                &nbsp;&nbsp;<input  id="Information_kindtop_0" rel="kindtop1" <?php if($model->kindtop == 1){echo 'checked="checked"';}?> value="1" type="radio" name="Information[kindtop]"> 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span id="Information_headtop" class="radioBox" style="display: none;">
                             &nbsp;&nbsp;<input id="Information_headtop_0" rel="headtop1" value="1" type="radio" <?php if($model->headtop == 1){echo 'checked="checked"';}?> name="Information[headtop]"> 
                ...
                <tr>
                    <td class="td_label">起始时间* ：</td>
                    <td>
                        <div style="display: inline;"> 
                            <?php echo $form->textField($model,'startdate',array('readonly'=>'readonly','rel'=>'nRecord','value'=>$model->getPublicInfoStartdate(),"onclick"=>'WdatePicker({dateFmt:"yyyy-MM-dd HH:mm:ss"})','style'=>'width: 180px; height:auto;','datatype'=>'*','nullmsg'=>'起始时间不能为空!','errormsg'=>'','class'=>'Wdate')); ?>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: inline;"> 
                            <?php echo $form->textField($model,'title',array('maxlength'=>'30','style'=>'width:300px;','datatype'=>'*1-20','nullmsg'=>'请输入资讯标题!','errormsg'=>'资讯标题长度不大于20个字!')); ?>
        ...
        <table class="tableForm">
            ...
            <tbody>
                <tr>
                    ...
                    <td> 
                    <?php if(!$model->isNewRecord): ?>
                        <input type="hidden" id="intTime" value="1">
                        <a id="sub_from" href="javascript:void(0);" class="btn btn-primary">保 存</a>
                        &nbsp;&nbsp;<a class="btn btn-default" href="<?php echo Yii::app()->createUrl('information/publicdel/'.$model->iid);?>"> 删 除 </a>
                    <?php else: ?>
