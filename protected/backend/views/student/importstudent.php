                        ...
                        <div style="display: inline;">
                             <select id="schoolId" name=" " datatype="*" nullmsg="请选择学校！">
                                 ...
                                 <?php if(is_array($schools)) foreach($schools as $key=>$val):?>
                                    <option value='<?php echo $key?>' <?php if($sid==$key) echo 'selected="selected"'; ?>><?php echo $val?></option>
                                 <?php endforeach; ?>
		                    </select>
                        </div>
                                   ...
                                   <tr class="msghmmCentenTr" style="display: none;">
                                       <td >
                                           ...
                                           <textarea maxlength="250" style="color: #606060" name="smscontent">
                                               你好！感谢您使用<?php echo SITE_NAME;?>（<?php echo SITE_URL;?>）,平台有家校沟通丶成绩管理等功能，我们的手机客户端同时推出，点击（<?php echo SITE_APP_DOWNLOAD_SHORT_URL;?>） 即可下载安装。您的账号:[xxxxxxxxxxx]，密码:[xxxxxx]。客服电话:4001013838，工作时间:08:00-20:00
