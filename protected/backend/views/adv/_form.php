        ...
        <table class="tableForm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: inline;"> 
                            <?php echo $form->textField($model,'title',array('size'=>35,'maxlength'=>35,'datatype'=>'*1-30','nullmsg'=>'广告标题不能为空！','errormsg'=>'广告标题不能超过30个字！')); ?>
                 ...
                 <tr>
                    ...
                    <td>
                        <div style="display: inline;"> 
                            <?php echo $form->textField($model,'summery',array('size'=>35,'maxlength'=>100,'datatype'=>'*1-30','ignore'=>'ignore','nullmsg'=>'','errormsg'=>'广告摘要不能超过30个字！')); ?>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: inline;"> 
                            <?php echo $form->textField($model,'url',array('datatype'=>'url', 'nullmsg'=>'链接地址不能为空！', 'errormsg'=>'请输入正确的链接地址！')); ?>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: inline;"> 
                            <?php echo $form->textArea($model,'text',array('rows'=>6, 'cols'=>50,'datatype'=>'*','ignore'=>'ignore','nullmsg'=>' ！','errormsg'=>'')); ?>
