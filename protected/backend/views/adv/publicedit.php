        ...
        <table class="tableForm"> 
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input rel="datatimeinput" readonly="readonly"   onclick="WdatePicker({maxDate:&quot;#F{$dp.$D('Advertisement_enddate')||'2080-10-01'}&quot;,dateFmt:&quot;yyyy-MM-dd&quot;})" style="width: 180px; height:auto;" class="Wdate" name="Advertisement[startdate]" id="Advertisement_startdate" type="text" value="<?php echo isset($model->car[0])?date('Y-m-d',strtotime($model->car[0]->startdate)):'';?>"> 
                                                            &nbsp;至&nbsp;
                        <input rel="datatimeinput" readonly="readonly"   onclick="WdatePicker({minDate:&quot;#F{$dp.$D('Advertisement_startdate')}&quot;,maxDate:&quot;2080-10-01&quot;,dateFmt:&quot;yyyy-MM-dd&quot;})" style="width: 180px; height:auto;" class="Wdate" name="Advertisement[enddate]" id="Advertisement_enddate" type="text" value="<?php echo isset($model->car[0])?date('Y-m-d',strtotime($model->car[0]->enddate)):'';?>">                                 
                    </td>
                </tr>
                <tr>
                    <td class="td_label">点击上限* ：</td>
                    <td>
                        <div style="display: inline;"> <input name="Advertisement[click]" id="Advertisement_click"  datatype="numb11" nullmsg='点击上限不能为空！' errormsg='点击上限不能超过11位数且只能为正整数' type="text" value="<?php echo isset($model->car[0])?$model->car[0]->click:0;?>"></div>
                        <span class="Validform_checktip"></span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: inline;">
                            <?php echo $form->textArea($model,'text',array('rows'=>6, 'cols'=>50,'ignore'=>'ignore','datatype'=>'*','nullmsg'=>'内容不能为空！','errormsg'=>'')); ?>
