<div class="box" style="position: relative;">
    ...
    <div id="popupViwe" style="overflow: hidden; z-index: 9999;">
        <div id="popupBoxViwe" class="popupBox" style="width:880px; height: 640px; margin-top: 0;">
...
$(document).on('change','[rel=con_item]',function(){
 ...
 var regionValue = ',';
    ...
    $(document).on("keyup","[name='totalclick']",function(){ 
        $("#findResultBox").hide();
        $("#query_result").empty();
        $('[rel=contype_query]').removeAttr("disabled");
    });
            ...
            if(location==""){
                ...
                if(totalclick==""){
                    ...
                    if(areas==""||grades==""){
                        ...
                        $("#findResultBox").show();
                       ajaxQueryConfig(order,sdate,edate,location,areas,grades,business,contype,objid,totalclick); 
                    }
               }
           }  
        } 
