 ...
 */
class SurveyQuestionAnswer extends MasterActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('sid, sqid, sqiid, userid, score', 'required'),
			array('sid, sqid, sqiid, score, state, deleted', 'numerical', 'integerOnly'=>true),
			array('userid', 'length', 'max'=>20),
			array('updatetime, creationtime', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('sqaid, sid, sqid, sqiid, userid, score, state, updatetime, creationtime, deleted', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('sqaid',$this->sqaid);
