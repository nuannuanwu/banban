...
<div class="box">
        ...
        <table class="tableForm searchForm" style="margin-bottom: 10px;"> 
            <tbody valign="middle">
                <tr valign="middle">
                    ...
                    <td width="45px"> 学校：</td>
                    <td width="130px">
                        <?php $sid = isset($ClientLogSchoolRelation['sid'])?$ClientLogSchoolRelation['sid']:''; ?>
                        <?php echo $form->dropDownList($model,'sid',School::getSchoolArr(),array('empty' => '--全部学校--','options' => array($sid=>array('selected'=>true)))); ?>
                    </td>
                ...
                <?php if(count($data['model'])): ?> 
                    <?php foreach($data['model'] as $log): ?>
                        <tr>
                            ...
                            <td>
                                <div class="commentBox" style=" zoom: 1;">
                                    <?php echo mb_substr($log->comment,0,10,'utf-8');?>
                                    <div class="commentPopBox" style=" ">
                                        <div class="commentHead">评价内容</div>
    ...
    <script type="text/javascript">
        ...
        $(".commentBox").hover(function(){
            $(this).addClass('pit');
            $(this).find('.commentPopBox').show();
        },function(){
            $(this).removeClass('pit');
            $(this).find('.commentPopBox').hide();
        });
    </script>
</div>
