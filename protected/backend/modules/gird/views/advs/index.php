                ...
                <?php if(count($data['model'])): ?> 
                    <?php foreach($data['model'] as $adv): ?>
                      <tr>
                          ...
                          <td><?php echo $adv->bname;?></td>
                          <td><?php echo $adv->gbid?'商业广告':'开放广告'; ?></td>
                           <td class="link_color"><a href="<?php echo Yii::app()->createUrl('gird/advs/browse/'.$adv->aid);?>"><?php echo $adv->viewcount;?></a></td>
