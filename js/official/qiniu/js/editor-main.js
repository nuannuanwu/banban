...
var updataLoadImg=function(uid){
    ...
    var uploader = Qiniu.uploader({
        ...
        dragdrop: true,
        chunk_size: '4mb',
        uptoken_url: parent.$('#uptoken_url').val(),
        domain: parent.$('#domain').val(),
        // rename:true,
        ...
        init: {
            ...
            'FileUploaded': function(up, file, info) {
                ...
                $.get(res+'?imageInfo',function(data){
                    if( data['width'] && data['height'] ){
                        ImageDialog.showPreviewImage(res);
                        $("#src").val(res+'?@='+data['width']+'_'+data['height']);
                    }else{
                        alert('上传异常, 请刷新重试');
                    }
                },'json');
