...
_848.panel({doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:1100040},onOpen:function(){
var p=$(this).panel("panel");
if($.fn.menu){
p.css("z-index",($.fn.menu.defaults.zIndex++)*10);
}else{
if($.fn.window){
p.css("z-index",($.fn.window.defaults.zIndex++)*10);
}
}
$(this).panel("resize");
},onBeforeClose:function(){
